        ...
        <div class="row mt-5">
            <div class="col-12">
                <h1 class="text-center text-danger">
                    Check Number Negative Or Positive
                </h1>
            </div>
            <div class="col-12 offset-0">
                <form method="post">
                    <div class="column form-group offset-4">
                        <div class="row col-6 mt-3 offset-1">
                            <div class="col-8">
                ...
                <?php 
                if(isset($status)){
                    echo "<div class='alert alert-$color offset-3 col-6'> The Number = $num1 , is  <strong> $status</strong> </div>";
                }
                ?>
            </div>
        </div>
