...
$errors=[];
 ...
 $resultCategories=$categories->getAll();
 if($resultCategories->num_rows >=1)
 {
    $finalresultCat=$resultCategories->fetch_all(MYSQLI_ASSOC);
 }
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                            <ul class="mega-menu">
                                                <?php foreach($finalresultCat as $category)
                                                {
                                                    $subcategories->setCategory_id($category['id']);
                                                    $resultSub=$subcategories->getsubByParent();
                                                    if($resultSub->num_rows >=1)
                                                    {
                                                     $finalsub=$resultSub->fetch_all(MYSQLI_ASSOC);
                                                    }
                                                    else {
                                                        $finalsub = [];
                                                    }
                                                ...
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"><a style="font-weight: bold;font-size:20px;" href="shop.php?cat=<?= $category['id'] ?>"><?php echo $category['name_en'];?></a></li>
                                                       <?php foreach($finalsub as $subcategory)
                                                       {?>
                                                        <li><a href="shop.php?sub=<?= $subcategory['id'] ?>"><?php echo $subcategory['name_en']?></a></li>
                                                      <?php  
                                                       }
